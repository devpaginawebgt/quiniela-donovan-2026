...
class EquipoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // ============================================================
        // Actualización de la columna `code` (FIFA alpha-3) por equipo.
        // El orden sigue la inserción anterior: Grupo A = ids 1-4,
        // Grupo B = 5-8, etc. Se usa para matchear con api_teams.code.
        // ============================================================
        $codes = [
            // Grupo A
