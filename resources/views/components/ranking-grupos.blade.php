<div class="w-full max-w-screen-2xl mx-auto mb-6 px-4 lg:px-8 pt-8">
    ...
    {{-- Podio --}}
    <div id="podio-grupos" class="items-end justify-center gap-3 xl:gap-4 mb-8" style="display: none;">
        ...
        <div class="w-full max-w-44">
            <div id="podio-2-grupos" style="display: none;" class="flex-col items-center">
                ...
                <p id="podio-2-name-grupos" class="text-xs xl:text-base font-semibold text-center leading-tight my-1"></p>
        ...
        <div class="w-full max-w-44">
            <div id="podio-1-grupos" style="display: none;" class="flex-col items-center">
                ...
                <p id="podio-1-name-grupos" class="text-xs xl:text-base font-semibold text-center leading-tight my-1"></p>
        ...
        <div class="w-full max-w-44">
            <div id="podio-3-grupos" style="display: none;" class="flex-col items-center">
                ...
                <p id="podio-3-name-grupos" class="text-xs sm:text-sm xl:text-base font-semibold text-center leading-tight my-1"></p>
