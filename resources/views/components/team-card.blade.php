...
<div
    class="team-card bg-complementary-primary border border-secondary rounded-3xl overflow-hidden cursor-pointer"
...
>
    ...
    <div class="flex items-center justify-between px-4 pb-3">
        ...
        <svg
            class="team-card-chevron w-4 h-4 text-complementary-light shrink-0 transition-transform duration-300"
